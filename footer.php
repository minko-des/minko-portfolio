                    <footer class="l-footer" id="contact">
                        <div class="p-footer  c-heading--playfair-display">
                            <div class="footer-top">
                                <p class="text-shape fadeIn">MINKO</p>
                            </div>
                            <div class="footer-content">
                                <div class="content-wrap">
                                    <div class="icon__group">
                                        <a class="insta-icon" href="https://www.instagram.com/m.i.n.k.okumkum/" target="_blank" rel="noopener noreferrer">
                                        ...
                                        <a class="github-icon" href="https://github.com/minko-des" target="_blank" rel="noopener noreferrer">
