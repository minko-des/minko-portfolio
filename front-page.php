        ...
        <section class="p-about">
            ...
            <div class="about-content">
                ...
                <div class="about-content__lead slideInFromUnder">
                    ...
                    <button class="c-link-btn slideInFromRight"><a href="<?php echo esc_url( get_permalink( get_page_by_path( 'about' ) ) ); ?>"><pre class="c-heading--inter">View More</pre></a></button>
                </div>
            </div>
        </section>
